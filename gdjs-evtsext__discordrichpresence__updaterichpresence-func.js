...
gdjs.evtsExt__DiscordRichPresence__UpdateRichPresence.userFunc0x1515dd8 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
gdjs.evtsExt__DiscordRichPresence__UpdateRichPresence.userFunc0x1515dd8(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
...
gdjs.evtsExt__DiscordRichPresence__UpdateRichPresence.func = function(runtimeScene, state, details, startTimestamp, endTimestamp, largeImageKey, largeImageText, smallImageKey, smallImageText, partyID, partySize, partyMax, parentEventsFunctionContext) {
...
if (argName === "partyID") return partyID;
if (argName === "partySize") return partySize;
if (argName === "partyMax") return partyMax;
    return "";
  },
